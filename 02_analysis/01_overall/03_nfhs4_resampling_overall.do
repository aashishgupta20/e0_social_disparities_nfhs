...
*Purpose: Bootstraps for overall estimates-NFHS4 *
**************************************************
...
**************************************************
	...
	*Log
	cap log close
	log using "$dir/02_logs/02analysis_nfhs4_resampling.txt", text replace
...
********************************************************
	...
	*drop singleton cluster in rural chandigarh 
	drop if v025 == 2 & v024 == 6 
...
forval z = 1(1)100{
	...
	*fcollapse 
	fcollapse (sum) deaths person_years, by(age_group female)
