...
********************************************************
	...
	*ex se 
	...
	save "$dir\04_input\resamples\bstraps\nfhs4\nfhs4_ex_se_group_rural.dta", replace
	...
	*nmx se 
	...
	save "$dir\04_input\resamples\bstraps\nfhs4\nfhs4_nmx_se_group_rural.dta", replace
	restore 
	...
	*lx se 
	...
	save "$dir\04_input\resamples\bstraps\nfhs4\nfhs4_lx_se_group_rural.dta", replace
...
*********************************************************
	...
	*collapse
	...
	, by(caste_religion age_group female rural)
	...
	*merge ex se 
	...
	"$dir\04_input\resamples\bstraps\nfhs4\nfhs4_ex_se_group_rural.dta", nogen
	...
	*merge nmx se 
	merge 1:1 rural caste_religion female age_group using ///
	"$dir\04_input\resamples\bstraps\nfhs4\nfhs4_nmx_se_group_rural.dta", nogen 
	...
	*merge lx se 
	merge 1:1 rural caste_religion female age_group using ///
	"$dir\04_input\resamples\bstraps\nfhs4\nfhs4_lx_se_group_rural.dta", nogen 
...
*******************************************************
	...
	saveold "$dir/05_out/estimates/nfhs4_group_rural_life_tables_se.dta", replace 
