...
**************************************************
	...
	*Log
	cap log close
	log using "$dir/02_logs/02analysis_nfhs2_group_ci.txt", text replace
...
*******************************************************
	...
	saveold "$dir/05_out/estimates/nfhs2_group_life_tables_se.dta", replace 
